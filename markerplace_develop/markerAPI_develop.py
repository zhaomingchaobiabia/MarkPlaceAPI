...
class SalesPeriodsApi(MarketPlaceApi):
            ...
            'sales_periods_query':
                {
                    ...
                    '@token': self.token, '@results_count': 10,
    ...
    def messages_update(self, update_dict):
        ...
        if 'message_to' not in update_dict:
            data_dict['messages_update']['message'] = {'@action': update_dict['action'], "@id": update_dict['id']}
        else:
            data_dict['messages_update']['message'] = {'@action': update_dict['action1'], '@id': update_dict['id'],
